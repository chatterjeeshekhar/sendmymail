...
if($acstat == "D")
echo "<font color='red'>(Suspended for your account)</font>";
?>
                      </h1>
...
<li class="time-label">
        ...
        <li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-body">
                    <pre><?php echo $weburl; ?>api/myapi.php?user=<?php echo $_SESSION['login_user']."&apikey=".$_SESSION['apikey']; ?>&sender={SenderEmail}&to={ReceiverEmail}&cc={CCEmail}&bcc={BCCEmail}&name={SenderName}&replyto={Replyto}&subject={EmailSubject}&body={EmailContent}&myfile={SingleAttachment}</pre>
                </div>
        ...
        <li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-body">
                    <pre><?php echo $weburl; ?>api/myapi.php?user=<?php echo $_SESSION['login_user']."&apikey=".$_SESSION['apikey']; ?>&sender={SenderEmail}&to={MultipleReceiverEmail}&cc={MultipleCCEmail}&bcc={MultipleBCCEmail}&name={SenderName}&replyto={Replyto}&subject={EmailSubject}&body={EmailContent}&myfile={SingleAttachment}</pre>
                </div>
                <div class="timeline-footer">
        ...
        <li>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-body">
                    <pre><?php echo $weburl; ?>api/mybalance.php?user=<?php echo $_SESSION['login_user']."&apikey=".$_SESSION['apikey']; ?></pre>
                </div>
                <div class="timeline-footer">
                    <b>Response :- </b>
  ...
  <li class="time-label">
            <span class="bg-aqua">Get API Key
            </span>
        </li>
        <!-- /.timeline-label -->
        ...
        <li>
            ...
            <div class="timeline-item">
                ...
                <h3 class="timeline-header">Get API Key</h3>
                <div class="timeline-body">
                    <pre><?php echo $weburl; ?>api/getkey.php?user=<?php echo $_SESSION['login_user'] ?>&pass=[protected from view]</pre>
                </div>
                <div class="timeline-footer">
                    <b>Response :- </b>
                    {"Key":"yourAPIkey"}
