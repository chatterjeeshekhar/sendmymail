...
<script src="https://cdn.ckeditor.com/4.4.3/standard/ckeditor.js"></script>
   ...
   <link href="../../plugins/tokenfield/css/tokenfield-typeahead.css" type="text/css" rel="stylesheet">
    <!-- Tokenfield CSS -->
    <link href="../../plugins/tokenfield/css/bootstrap-tokenfield.css" type="text/css" rel="stylesheet">
    <!-- Docs CSS -->
    <link href="../../plugins/tokenfield/css/pygments-manni.css" type="text/css" rel="stylesheet">
    <link href="../../plugins/tokenfield/css/docs.css" type="text/css" rel="stylesheet">
  <script type="text/javascript" src="https://code.jquery.com/jquery-1.9.1.js"></script>
    <script type="text/javascript" src="https://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
    <script type="text/javascript" src="../../plugins/tokenfield/js/bootstrap-tokenfield.js" charset="UTF-8"></script>
    <script type="text/javascript" src="../../plugins/tokenfield/js/scrollspy.js" charset="UTF-8"></script>
    <script type="text/javascript" src="../../plugins/tokenfield/js/docs.min.js" charset="UTF-8"></script>
...
$sql1 = "select * from groups where user='".$usern."' and level=2;";
...
echo '<form enctype="multipart/form-data" name="Form" method="post" action="" onsubmit="return ValidateForm()">
                <div class="box-body">
                  <div class="form-group">
                    <textarea name="toemail" placeholder="To: Seperated by comma" id="recemail2" class="form-control" required="required"></textarea>
...
<div class="form-group">
                       <input name="ccemail" id="recemail2" placeholder="CC" class="form-control">
                
                  </div>
    <div class="form-group">
                       <input name="bccemail" id="recemail3" placeholder="BCC" class="form-control">
  ...
  <div class="form-group">
                    <div class="btn btn-default btn-file">
                      ...
                      <input type="file" name="Resume[]" multiple="multiple">
                    </div>
                    <p class="help-block">Max. 25GB</p>
                  </div>
...
{
var cont = $('#recemail2').val();
 $.get("grpemails.php?i="+str, function(data, status){
        document.getElementById("recemail2").value=cont+","+data;
