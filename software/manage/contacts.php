...
<button type='button' class='btn btn-success' data-toggle='modal' data-target='#myModal2'>Import from Excel</button>
 <a href='group.php' class='btn btn-warning'>Add New Group</a> </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
$mysqlstat = "SELECT * FROM contacts where user='$userac' and level=2 ORDER BY name ASC";
...
$sql = "INSERT INTO contacts (name, email, user, grp, time, level) VALUES ('".$varname."', '".$varemail."', '".$usern."', '".$vargrp."', (NOW() + INTERVAL '$tz' MINUTE), '2');";
