            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal'>Add New</button> <button type='button' class='btn btn-success' data-toggle='modal' data-target='#myModal3'>Import from Excel</button></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
$mysqlstat = "SELECT * FROM groups where user='$userac' and level=2 ORDER BY grpname ASC";
...
$sql = "INSERT INTO groups (grpname, user, time, level) VALUES ('".$varname."', '".$usern."', (NOW() + INTERVAL 630 MINUTE), '2');";
   $retval = mysql_query( $sql, $connection );
echo '<script>response.setHeader("Refresh", "0; URL=groups.php");</script>';
}
else{
...
$phpvar='"+str+"';
$ppwp = $phpvar;
$urlstr = $_SESSION['projectweb']."getgrp.php?i=".$ppwp;
  ...
  <form method="post" action="" enctype="multipart/form-data">                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Select File (xls format only)</label>
                       <input name='fileToUpload' type='file' class='form-control' accept='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel' required>                    
                    </div>     
                    <div class="form-group">
