...
$parlink = $_SERVER['REQUEST_URI'];
	echo "<center><table class='table table-bordered table-striped' border='1' width='90%' bordercolor=black><tr><td></td><td><a href='$parlink' target='_parent' class='btn btn-success'>Open in New Tab</a></td></tr><tr><td>ID</td><td>".$row['ID']."</td></tr><tr><td>From</td><td>".$row['Sender']."</td></tr><tr>";
...
echo "<td>Reply-to</td><td>" . $row['Replyto'] . "</td></tr>";
	...
	$urlstr = $_SESSION['projectweb']."getcont2.php?i=".$i1;
