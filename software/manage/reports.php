...
$phpvar='"+str+"';
$ppwp = $phpvar;
$urlstr = $_SESSION['projectweb']."getcont.php?i=".$ppwp;
//echo file_get_contents($urlstr);
...
echo "";
   ?>";
    ...
    <div class='modal-footer'><button type='button' class='btn' href='<?php echo $urlstr; ?>' target='_new'>Open In New Tab</button>
