...
$sql ="update login set fname='$fname', lname='$lname', email='$useremail', address='$address', city='$city', country='$country', tel='$tel' where username='$userac';";
...
include 'web/connect.php';
$userac = $_SESSION['login_user'];
$query = mysqli_query($con,"update login set password=md5('$newpas') where username='$userac' and password=md5('$curpas')");
